...
feature "user can see reviews" do
  scenario "user visits the release page and sees reviews" do
    ...
    new_release = Release.create!(title: 'Album', artist: 'Artist', year: 1987, studio: 'Mororsion',
                  no_of_tracks: 9, album_art_url: 'http://tasteofcountry.com/files/2011/03/ralph-mooney.jpg',
                  user: danger)
